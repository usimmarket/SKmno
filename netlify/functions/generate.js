...
// --- Address derived fields (do not change index.html) ---
// mapping.json uses "addr" / "addr_1" but the form collects addr_road + addr_detail.
if(!("addr" in data) || !String(data.addr||"").trim()){
...
if(!("addr_1" in data) || !String(data.addr_1||"").trim()){
  if(String(data.addr||"").trim()) data.addr_1 = data.addr;
}
// --- end ---

...
// Auto-check mnp1~mnp3 only when join_type is Port-in (번호이동)
const isPortIn =
  data.join_type === "port" ||
  data.join_type === "번호이동" ||
  data.join_type__port === "1" ||
  data.join_type__port === "Y" ||
  data.join_type__port === "on" ||
  data.join_type__port === true ||
  data.join_type__port === "true";
...
if (isPortIn) {
  ...
  // ensure cleared so nothing prints when not port-in
  data.mnp1 = "";
  data.mnp2 = "";
  data.mnp3 = "";
}
